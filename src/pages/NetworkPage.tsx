				...
				<div className="max-w-3xl mx-auto relative">
					...
					>
						...
						<p className="text-xl text-brand-muted font-medium leading-relaxed max-w-2xl mx-auto">
							Our Hub & Spoke model connects waste oil sources across Assiut
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-slate-500 font-medium max-w-xl mx-auto">
							From signing up a restaurant to delivering biodiesel — every step
			...
			<section className="py-24 px-6 bg-brand-background">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-slate-500 font-medium max-w-xl mx-auto">
							Whether you're a single household or a franchise chain — there's a
							place for you in the network.
						</p>
					</div>
