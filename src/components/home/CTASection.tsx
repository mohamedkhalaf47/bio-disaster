		...
		<section className="py-24 px-6">
			...
			>
				...
				<div className="flex flex-col sm:flex-row gap-6 justify-center">
					...
					<button className="h-16 px-12 bg-slate-900 text-white text-lg font-bold rounded-2xl shadow-2xl shadow-slate-200 hover:scale-105 transition-all flex items-center justify-center gap-3">
