				...
				<div className="max-w-3xl mx-auto relative">
					...
					>
						...
						<p className="text-xl text-brand-muted font-medium leading-relaxed max-w-2xl mx-auto">
							Every liter of waste oil we collect reduces pollution, creates
							energy, and moves Assiut toward a cleaner future.
						</p>
					</motion.div>
				</div>
			</div>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-slate-500 font-medium max-w-xl mx-auto">
							From direct workers to entire communities — BioDiesel creates a
							ripple effect across Assiut.
						</p>
					</div>
									...
									<Card className="h-full">
										<div className="flex items-center gap-4 mb-6">
											...
											<div>
												...
												<p className="text-2xl font-display font-black tracking-tighter text-brand-primary">
													{group.range}
												</p>
											</div>
										</div>
			...
			<section className="py-24 px-6 bg-brand-background">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-slate-500 font-medium max-w-xl mx-auto">
							BioDiesel directly contributes to 6 of the UN's 17 Sustainable
							Development Goals.
						</p>
					</div>
							...
							>
								<Card className="h-full group hover:border-brand-primary/30">
									<div className="flex items-center gap-4 mb-5">
										<span
											className={`w-14 h-14 shrink-0 ${sdg.color} text-white rounded-2xl flex items-center justify-center font-black text-sm shadow-lg`}
										>
											{sdg.number.split(" ")[1]}
										</span>
										<div>
											...
											<h3 className="font-extrabold text-brand-text leading-tight">
												{sdg.label}
											</h3>
										</div>
									</div>
					...
					>
						...
						<div className="relative grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
							{[
								{
									icon: <Leaf className="text-brand-accent" size={28} />,
									val: "1–5 tons",
									label: "CO₂ equivalent avoided / month",
								},
								{
									icon: <BarChart3 className="text-brand-accent" size={28} />,
									val: "1,000–3,000 L",
									label: "waste oil diverted from landfills",
								},
								{
									icon: <Users className="text-brand-accent" size={28} />,
									val: "500–2,000",
									label: "people saved from oil pollution effects",
								},
							].map((item, i) => (
								<div key={i} className="flex flex-col items-center gap-3">
									...
									<p className="text-3xl font-display font-black tracking-tighter text-brand-accent">
										{item.val}
									</p>
