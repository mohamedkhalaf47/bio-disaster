...
const ICONS: Record<string, LucideIcon> = { Globe, Camera, Mail };
			...
			<div className="md:col-span-1">
				<div className="flex items-center gap-3 mb-8">
					<div className="w-10 h-10 bg-brand-primary rounded-xl flex items-center justify-center text-white shadow-lg shadow-brand-primary/20">
						<div className="flex flex-col items-center">
							<span className="font-display font-black text-lg leading-none -mb-0.5">
								b
							</span>
							<Droplet
								size={12}
								className="text-brand-accent fill-brand-accent/20"
							/>
						</div>
					</div>
				...
				<div className="flex gap-4">
					{SOCIAL_LINKS.map((social, idx) => {
						const Icon = ICONS[social.iconName as string];
						return (
							<a
								key={idx}
								href={social.url}
